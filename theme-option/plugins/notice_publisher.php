...
function dm_notice_list_shortcode($atts) {
    ...
    $output .= '    text-decoration: none;';
    $output .= '    transition: background-color 0.3s ease;font-size:14px;text-transform:capitalize /* Add a smooth transition effect */';
    $output .= '}';
    $output .= '.button.button-primary:hover {';
    $output .= '    background-color: #0c4f00; color:#fff;/* Change the background color on hover */';
    $output .= '}';
    $output .= '.date-column {';
