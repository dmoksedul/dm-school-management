...
=================================================================================== -->
   <div id="theme_customize_body">
    ...
    <div id="customize_side_bar">
      <ul>
        <li><button data-target="contact_information" class="toggle-tab active">General Settings</button></li>
        ...
        <li><button data-target="" class="toggle-tab">Shortcode</button></li>
        <li><button data-target="color_editor_tab" class="toggle-tab">Settings</button></li>
      </ul>
    </div>
    ...
    <form action="options.php" method="post">
            ...
            <div id="contact_information" class="editor-tab active">
...
<!-- ================================================================================================================== -->
            ...
            <input class="dm_save_button" type="submit" name="submit" value="<?php _e('Save Change', 'dmoksedul') ?>">

            <input class="dm_save_button2" type="submit" name="submit" value="<?php _e('Save Change', 'dmoksedul') ?>">
