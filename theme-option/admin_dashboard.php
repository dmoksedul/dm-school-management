...
function dm_add_theme_menu() {
    ...
    add_submenu_page( 'dm_theme_settings', 'Theme Customize', 'Customize', 'manage_options', 'dm_customize', 'dm_theme_customize_page' );
...
function dm_theme_customize_page() {
    ...
    require_once(get_template_directory() . '/theme-option/theme_customize.php');
}
